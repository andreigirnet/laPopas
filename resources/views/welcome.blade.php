...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    {{--                                @endif--}}
                        ...
                        <div class="smallCartUpper">
                            ...
                            <div class="smallOrderAmount">0.00</div>
                                  ...
                                  <template x-for="(product, productKey) in item" x-bind:key="productKey">
                                          ...
                                          <div class="productCard" x-on:mouseenter="hoveredProduct = productKey" x-on:mouseleave="hoveredProduct = null">
                                              ...
                                              <div class="priceContainer">
                                                  ...
                                                  <div class="cartAddProductContainer" x-on:mouseenter="cartHovered = productKey" x-on:mouseleave="cartHovered = null">
        ...
        <section class="infoSection">
            <div class="infoContainer">
                ...
                <div class="paymentInfo">Payment Methods</div>
                <div class="deliveryInfo">Time Of Delivery</div>
            </div>
        </section>
